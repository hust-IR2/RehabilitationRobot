...
//        ctx.text(Number(camera0.pupilCenter.x).toLocaleString(Qt.locale("de_DE")) + Number(camera0.pupilCenter.y).toLocaleString(Qt.locale("de_DE")), camera0.pupilCenter.x, camera0.pupilCenter.y);
//        ctx.stroke();
        robot.getRightCenter(camera0.pupilCenter)
    }
  }
//  ComboBox {
